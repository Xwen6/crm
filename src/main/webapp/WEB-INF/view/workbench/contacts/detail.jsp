...
<script type="text/javascript">
	...
	$(function(){
		...
		$("#editContactsBtn").click(function () {
				...
				/*获取记录的id*/
				var id = "${requestScope.contacts.id}"
				$.ajax({
		...
		$("#updateBtn").click(function (){
			...
			$.ajax({
				...
				data : {
					...
					"source" : $.trim($("#edit-source").find("option:selected").text()),
...
*/
						...
						alert("修改成功")
						window.location.href='workbench/contacts/detail.do?id='+"${requestScope.contacts.id}"
		...
		$("#deleteBtn").click(function (){
			if (confirm("确定要删除吗？")){
				...
				$.ajax({
					...
					data :{"ids":"${requestScope.contacts.id}"},
					type :  "get",
					dataType : "json",
					success : function (data){
						if(data.success){
							/*刷新删除后的的跳转到index页面*/
							window.location.href='web/system/toContacts.do'
		...
		$("#updateRemarkBtn").click(function () {
			...
			$.ajax({
				url : "workbench/contacts/remarkUpdate.do",
		...
		$.ajax({
			...
			success : function (data) {
				...
				$.each(data,function (index,element) {
					...
					html += '<font color="gray">联系人</font> <font color="gray">-</font> <b>${requestScope.contacts.fullname}</b> <small style="color: gray;" id="s'+element.id+'"> '+(element.editFlag==0?element.createTime:element.editTime)+' 由'+(element.editFlag==0?element.createBy:element.editBy)+'</small>';
...
<body>
	...
	<div style="position: relative; left: 40px; top: -30px;">
		...
		<div style="position: relative; height: 50px; width: 500px;  top: -72px; left: 700px;">
			<button type="button" id="editContactsBtn" class="btn btn-default"><span class="glyphicon glyphicon-edit"></span> 编辑</button>
